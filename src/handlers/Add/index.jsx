...
class Add extends React.Component {
  ...
  addItemToCart = (event) => {
    ...
    if(qty) {
      console.log(formObj.product[index].text);
      ...
      <div className="base-container">
        ...
        {this.state.cartItems.length > 0 && 
          <form name="OrderForm">
            ...
            <button type="button" className="btn btn-primary big" onClick={this.submitOrder}>Submit Order</button>
          </form>
        }
      </div>
    );
